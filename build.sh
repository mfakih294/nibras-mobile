export PATH=/nbr/dev/Android/Sdk/tools:/nbr/dev/Android/Sdk/tools/bin:/nbr/dev/Android/Sdk/build-tools/29.0.2:/nbr/dev/Android/Sdk/platform-tools:/usr/lib/jvm/java-8-openjdk-amd64/bin:/usr/lib/jvm/java-8-openjdk-amd64/bin/:$PATH
